 ...
 * @author top1z
 */
public class form_demo extends javax.swing.JDialog {
...
//            stm = cn.createStatement();
            ...
            pred.setString(1, model.getValueAt(index, 0).toString());
            mess("đã xóa");
//                loadtable();
            clear();
            pred.close();
...
//            public void run() {
////                form_demo dialog = new form_demo(new javax.swing.JFrame(), true);
